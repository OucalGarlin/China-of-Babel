        ...
        local items={
            {
                ...
                {QUA=2,
                ACR="获得魂心 + 射速上升 + 泪弹体积上升"}--你是不是以为自己属性给的很慷慨？
            },{
